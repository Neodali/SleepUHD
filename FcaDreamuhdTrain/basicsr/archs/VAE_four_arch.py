...
def make_res(in_channels, out_channels,temb_channels,dropout, res_type="vanilla"):
    assert res_type in ["vanilla", "Fourmer","MAB","Res_four","Res_four2","Res_four3","Res_four4","Res_four5","Res_four6","Res_four7","Res_four8","Res_four9","Res_four10","Res_four11","Res_four12","FEblock","FEblock2","none"], f'res_type {res_type} unknown'
